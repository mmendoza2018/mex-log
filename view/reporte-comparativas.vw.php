<?php
                ...
                $model = "model/Reporte-comparativas_model.php";
		$controller = "controller/Reporte-comparativas_controller.php";
	...
	//$objReporteMercadotecnia =  new Cuentasdebancos();
        $objReporteComparativas =  new Reportecomparativas();
			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Comparativas</li>
					</ul>
				</div>
                                <div class="panel-heading">
                                    <h5 class="panel-title">Reporte financiero / Comparativas</h5> 
                            ...
                            <span class="label label-default label-primary" style="font-size: 1.2em; width: 100% ">Store Manager / Comparativas </span>
					...
					<table class="table datatable-basic table-xxs table-hover">
						...
						<tbody>
						  ...
						  <?php 
								$filas = $objReporteComparativas->Listar_Conceptos_Reporte_comparativas();
...
<script type="text/javascript" src="web/custom-js/reporte-comparativas.js"></script>
