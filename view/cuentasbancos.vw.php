			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li><a href="javascript:;">Modelo JCV</a></li>
						<li class="active">Cuentas de bancos</li>
					</ul>
				</div>
					<div class="panel-heading">
						<h5 class="panel-title">Cuentas JCV</h5>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                                ...
                                                                                <input type="text" id="txtObservaciones" name="txtObservaciones" placeholder="EJ. VENTA DE SUMINISTROS"
                                                                                 class="form-control" style="text-transform:uppercase;"
                                                                                 onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                                <label>Cuenta </label>
                                                                                <input type="text" id="txtCuenta" name="txtCuenta" placeholder="EJ ACTIVO FIJO"
                                                                                class="form-control" style="text-transform:uppercase;"
                                                                                onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                                        </div>
