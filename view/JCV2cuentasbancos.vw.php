					...
					<table class="table datatable-basic table-xxs table-hover">
						...
						<tbody>
						  ...
						  <?php
								...
								?>
									<tr>
					                	<td><?php print($column['idcuenta']); ?></td>
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													onclick="openCuentasBancos('editar',
								                     '<?php print($column["idcuenta"]); ?>',
                          	...
                          	<input type="hidden" id="txtProceso" name="txtProceso" class="form-control" value="">
						           ...
						           <div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												<label>Id</label>
												<input type="text" id="txtIdcuenta" name="txtIdcuenta" placeholder="AUTOGENERADO"
