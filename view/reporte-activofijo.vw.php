<?php
                ...
                $model = "model/Reporte-activofijo_model.php";
		$controller = "controller/Reporte-activofijo_controller.php";
	...
	//$objReporteMercadotecnia =  new Cuentasdebancos();
        $objReporteActivofijo =  new ReporteActivofijo();
				...
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Activo fijo</li>
                                ...
                                <div class="panel-heading">
                                    <h5 class="panel-title">Reporte financiero / Activo fijo</h5> 
                            ...
                            <span class="label label-default label-primary" style="font-size: 1.2em; width: 100% ">Store Manager / Activo fijo </span>
					...
					<table class="table datatable-basic table-xxs table-hover">
						...
						<tbody>
						  ...
						  <?php 
								$filas = $objReporteActivofijo->Listar_Conceptos_Reporte_activofijo();
...
<script type="text/javascript" src="web/custom-js/reporte-activofijo.js"></script>
