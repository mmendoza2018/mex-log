			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Primer semestre</li>
					</ul>
				</div>
					<div class="panel-heading">
						<h5 class="panel-title">Estado de resultados / Primer semestre</h5>
						...
						<div class="heading-elements">
                            ...
                            <span class="label label-default label-primary" style="font-size: 1.2em; width: 100% ">Estado de Resultados 1er Semestre </span>
...
<script type="text/javascript" src="web/custom-js/estadoresultados1.js"></script>
