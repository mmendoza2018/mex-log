			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Ingenieros</li>
					</ul>
				</div>
					<div class="panel-heading">
						<h5 class="panel-title">Ingenieros</h5>
						...
						<div class="modal-content">
                            ...
                            <input type="hidden" id="txtProceso" name="txtProceso" class="form-control" value="">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-8">
												<label>Ingeniero <span class="text-danger">*</span></label>
												<input type="text" id="txtTecnico" name="txtTecnico" placeholder="EJ. ALEJANDRO MAGNO"
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-8">
												...
												<input type="text" id="txtTelefono" name="txtTelefono" placeholder="EJ. 55 1944 9646"
												 class="form-control" style="text-transform:uppercase;"
                        onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
