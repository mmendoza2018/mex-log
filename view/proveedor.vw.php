								...
								<div class="alert alert-info alert-styled-left text-blue-800 content-group">
						           ...
						           <div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												<label>Whats app <span class="text-danger">*</span></label>
												<input type="text" id="txtNIT" name="txtNIT" placeholder="EJ. 55 2359 2046"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
											...
											<div class="col-sm-6">
												...
												<input type="text" id="txtNRC" name="txtNRC" placeholder="EJ. VAX0210105Y6"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-8">
												...
												<input type="text" id="txtTelefono" name="txtTelefono" placeholder="EJ. 55 8969 9646"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<input type="text" id="txtTelefonoC" name="txtTelefonoC" placeholder="EJ. 55 9869 3621"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
