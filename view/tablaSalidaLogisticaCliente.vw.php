              ...
              <ul class="icons-list">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <?php } else { ?>
                      <li><a data-toggle="modal" onclick="obtenerListaSalidasPorVenta('<?php echo $idReferencia ?>')" data-target="#modalDetalleEntrada">
                        <i class=" icon-eye8">
                        </i> Ver lista</a>
                    </li>
                    <?php } ?>
                    <li>
                      <a href="./?View=NuevaSalidaLogistica&tipo=<?php echo ($tipoRegistro == 'VENTA') ? 'venta' : 'entrada'  ?>&id=<?php echo $idReferencia ?>">
                        <i class="icon-pencil6"></i>
                        Agregar
                      </a>
                    </li>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-container">
          <h5 class="text-center">Registros agregados</h5>
          <div id="llegaTablaSalidaslog">
