...
?>
			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					...
					<div class="panel-heading">
						<h5 class="panel-title">Atributos</h5>

						<div class="heading-elements">
							<button type="button" class="btn btn-primary heading-btn"
							onclick="newCuentasatributos()">
							...
							<div class="btn-group">
		                    	...
		                    	<ul class="dropdown-menu dropdown-menu-right">
									...
									><i class="icon-file-pdf"></i> Atributos Activos</a></li>
									<li class="divider"></li>
									<li><a id="print_inactivos" href="javascript:void(0)">
									<i class="icon-file-pdf"></i> Atributos Inactivos</a></li>
								</ul>
							</div>
			...
			<!-- Iconified modal  JCV PARA AGREGAR MAS ATRIBUTOS CRUD DE ATRIBUTOS -->
