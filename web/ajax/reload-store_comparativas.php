...
/*JCV OBTENIDO DEL ARCHIVO reload-cuentasdebancos.php*/ 
	function __autoload($className){
		...
		//$controller = "../../controller/". $className ."_controller.php";
                ...
                $model = "../../model/Reporte-store_comparativas_model.php"; 
		$controller = "../../controller/Reporte-store_comparativas_controller.php";  
	...
	$objCuentasdebancos =  new Reportecomparativas(); 
 ...
 <div id="reload-div"> 
        <table class="table datatable-basic table-xxs table-hover">
            ...
            <?php 
                $filas2 = $objCuentasdebancos->Insertar_datos_comparativas();    
               
                $filas=$objCuentasdebancos->Listar_comparativas();  
...
<script type="text/javascript" src="web/custom-js/reporte-store-comparativas.js"></script>      
