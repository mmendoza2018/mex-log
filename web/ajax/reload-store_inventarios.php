...
/*JCV OBTENIDO DEL ARCHIVO reload-cuentasdebancos.php*/ 
	function __autoload($className){
		...
		//$controller = "../../controller/". $className ."_controller.php";
                ...
                $model = "../../model/Reporte-store_inventarios_model.php"; 
		$controller = "../../controller/Reporte-store_inventarios_controller.php"; 
	...
	$objCuentasdebancos =  new Reporteinventarios();
 ...
 <div id="reload-div"> 
        <table class="table datatable-basic table-xxs table-hover">
            ...
            <?php 
                $filas2 = $objCuentasdebancos->Insertar_datos_inventarios();   
               
                $filas=$objCuentasdebancos->Listar_inventarios();  
            ...
            ?> 
                ...
                if($column['nivel']==84 or $column['nivel']==89 or $column['nivel']==94 or $column['nivel']==305 or $column['nivel']==306){
                ?>        
...
<script type="text/javascript" src="web/custom-js/reporte-store-inventarios.js"></script>   
