...
/*JCV OBTENIDO DEL ARCHIVO reload-cuentasdebancos.php*/ 
	function __autoload($className){
		...
		//$controller = "../../controller/". $className ."_controller.php";
                ...
                $model = "../../model/Reporte-store_edoresultados_model.php";
		$controller = "../../controller/Reporte-store_edoresultados_controller.php"; 
	...
	$objCuentasdebancos =  new Reporteedoresultados();
 ...
 <div id="reload-div">
        <table class="table datatable-basic table-xxs table-hover">
            ...
            <?php
                ...
                $filas=$objCuentasdebancos->Listar_edoresultados();
            ...
            ?> 
                ...
                if($column['nivel']==53 or $column['nivel']==54 or $column['nivel']==59 or $column['nivel']==60 or $column['nivel']==63 or $column['nivel']==64){
                ?>        
...
<script type="text/javascript" src="web/custom-js/reporte-edoresultados.js"></script>
