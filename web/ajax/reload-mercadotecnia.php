...
/*JCV OBTENIDO DEL ARCHIVO reload-cuentasdebancos.php*/ 
	function __autoload($className){
		...
		//$controller = "../../controller/". $className ."_controller.php";
                ...
                $model = "../../model/Reporte-mercadotecnia_model.php";
		$controller = "../../controller/Reporte-mercadotecnia_controller.php";
	...
	$objCuentasdebancos =  new Reportemercadotecnia();
 ...
 <div id="reload-div">
        <table class="table datatable-basic table-xxs table-hover">
            ...
            <?php
                ...
                $filas=$objCuentasdebancos->Listar_mercadotecnia();
            ...
            ?> 
                ...
                if($column['nivel']==9 or $column['nivel']==11 or $column['nivel']==12){
                ?>        
