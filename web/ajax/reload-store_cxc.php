...
/*JCV OBTENIDO DEL ARCHIVO reload-cuentasdebancos.php*/ 
	function __autoload($className){
		...
		//$controller = "../../controller/". $className ."_controller.php";
                ...
                $model = "../../model/Reporte-store_cxc_model.php"; 
		$controller = "../../controller/Reporte-store_cxc_controller.php"; 
	...
	$objCuentasdebancos =  new Reportecxc();
 ...
 <div id="reload-div"> 
        <table class="table datatable-basic table-xxs table-hover">
            ...
            <?php 
                $filas2 = $objCuentasdebancos->Insertar_datos_cxc();  
               
                $filas=$objCuentasdebancos->Listar_cxc(); 
            ...
            ?> 
                ...
                if($column['nivel']==207 or $column['nivel']==208){
                ?>        
...
<script type="text/javascript" src="web/custom-js/reporte-store-cxc.js"></script>  
