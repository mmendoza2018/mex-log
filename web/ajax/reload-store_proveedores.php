...
/*JCV OBTENIDO DEL ARCHIVO reload-cuentasdebancos.php*/ 
	function __autoload($className){
		...
		//$controller = "../../controller/". $className ."_controller.php";
                ...
                $model = "../../model/Reporte-store_proveedores_model.php"; 
		$controller = "../../controller/Reporte-store_proveedores_controller.php";  
	...
	$objCuentasdebancos =  new Reporteproveedores(); 
 ...
 <div id="reload-div"> 
        <table class="table datatable-basic table-xxs table-hover">
            ...
            <?php 
                $filas2 = $objCuentasdebancos->Insertar_datos_proveedores();    
               
                $filas=$objCuentasdebancos->Listar_proveedores();  
            ...
            ?> 
               <!--<tr> -->
                ...
                if($column['nivel']==407 or $column['nivel']==408){
                ?>        
...
<script type="text/javascript" src="web/custom-js/reporte-store-proveedores.js"></script>     
