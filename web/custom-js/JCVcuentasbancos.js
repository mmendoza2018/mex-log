...
function openCuentasBancos(action, id, fecha, concepto, ingreso, egreso, saldo, observaciones, tipocuenta)
 {
...
function enviar_frm()
{
  ...
  var dataString='proceso='+proceso+'&id='+id+'&fecha='+fecha+'&concepto='+concepto+'&ingreso='+ingreso+'&egreso='+egreso;
