...
$(document).off('click', '#cargar_datos_A'); ///JCV PARA QUE NO ESTE RECICLEANDO LA FUNCION Y SE VAYA INVREMENTANDOEL NUMERO DE VECESQUE SE REPITE CADA VEZ QUE SE ELIJE
 $(document).on('click', '#cargar_datos_A', function(e){
 ...
 */
    ...
    {     
        ...
        $.ajax({ 
           ...
           //DEL DE VENTAS url:"web/ajax/reload-ventas_fecha.php?fecha1="+fecha1+"&fecha2="+fecha2,
           //JCV OK SI FUNCIONA SIN FECHAS url:"web/ajax/reload-librodiariobancos.php?id_debancosL="+id_debancosL,
           url:"web/ajax/reload-flujoefectivo_A.php",
           
           beforeSend: function(objeto) {
					
                $('#loaderA').html('<img src="img/ajax-loaderOKJCV.gif"> Cargando...');
            },
           success: function(data){
               $('#loaderA').html(''); 
              $('#reload-divA').html(data);
