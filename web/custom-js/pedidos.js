    ...
    var filas=0;
      ...
      if(inventariable == 0){
                ...
                '<span class="text-muted">'+especificacion+'</span></td>';
                 tr_add += '<td width="5%"><input type="text" id="tblcant" name="tblcant" value="1.00" class="touchspin" style="width:100%;"></td>';
                 tr_add += '<td align="center">';
                 tr_add += '<select class="form-control select-precio-venta" style="width:95%">';
