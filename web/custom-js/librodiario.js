...
function newLibrodiario()
 {
    ...
    openLibrodiario('nuevo',null,null,null,null,null,null,null,null,null,null,null,null,null);
    $('#modal_iconified').modal('show');
 }
function openLibrodiario(action, id_librodiario, codigo_librodiario, fecha, nombre_cuentaderegistro, ingreso, egreso, saldo, observaciones, nombre_cuentaacumulativa, nombre_cuentadebanco, id_deregistroR, id_debancosL, id_acumulativa, naturalezaL, estado)
 {
...
var id_acumulativa =$("#txtidacumulativa").val();  
  ...
  dataString+='&nombre_cuentaderegistro='+nombre_cuentaderegistro+'&saldo='+saldo+'&nombre_cuentaacumulativa='+nombre_cuentaacumulativa+'&observaciones='+observaciones+'&nombre_cuentadebanco='+nombre_cuentadebanco+'&id_deregistroR='+id_deregistroR+'&id_debancosL='+id_debancosL+'&naturalezaL='+naturalezaL+'&id_acumulativa='+id_acumulativa;
//alert('holaenviarfrm');
  $.ajax({
     type:'POST',
     url:urlprocess,
