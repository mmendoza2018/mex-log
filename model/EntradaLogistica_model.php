...
class EntradaLogisticaModel extends Conexion
{

  public static function ListarEntradasLogistica($idEntrada = false)
  {
  ...
  public static function ListarEntradasLogisticaPorVenta($idVenta = false)
  {
    $dbconec = Conexion::Conectar();
    ...
    try {
      ...
      $query .= "INNER JOIN facturas_compras fc ON el.id_factura = fc.id_factura WHERE id_venta = $idVenta";
      $stmt = $dbconec->prepare($query);
      $stmt->execute();
  ...
  public static function ListarDetalleProductosPorVenta($idVenta)
  {
    $dbconec = Conexion::Conectar();
    ...
    try {
      ...
      $query .= " LEFT JOIN facturas_compras fc ON el.id_factura = fc.id_factura";
      $query .= " WHERE fc.id_venta = $idVenta";
      $stmt = $dbconec->prepare($query);
      $stmt->execute();
  ...
  public static function obtenerlistaGeneral()
  {
    $dbconec = Conexion::Conectar();
    ...
    try {
      ...
      $query =   "SELECT
                        fv.id_factura as id_referencia,
                        fv.fecha_factura AS fecha_registro,
                        c.nombre_cliente AS nombre_cliente,
                        u.nombre_users AS nombre_vendedor,
                        'VENTA' AS tipo_registro
                  FROM
                  facturas_ventas fv
                  LEFT JOIN clientes c ON fv.id_cliente = c.id_cliente
                  LEFT JOIN users u ON fv.id_vendedor=u.id_users 

                  UNION

                  SELECT
                    el.id_entrada as id_referencia,
                    el.fecha_registro as fecha_registro,
                    c.nombre_cliente as nombre_cliente,
                    NULL as nombre_vendedor,
                    el.tipo_entrada as tipo_registro
                  FROM
                  entradas_logistica el
                  LEFT JOIN clientes c ON el.id_cliente = c.id_cliente";
