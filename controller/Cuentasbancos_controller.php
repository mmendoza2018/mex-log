<?php
	...
	class Cuentasbancos {
		...
		public function Editar_Cliente($idcliente, $fecha, $concepto, $ingreso, 
		$egreso, $saldo, $observaciones, $tipo_de_gasto, $estado){

			$cmd = ClienteModel::Editar_Cliente($idcliente, $fecha, $concepto, $ingreso, 
			$egreso, $saldo, $observaciones, $tipo_de_gasto, $estado);
		...
		$cmd = ClienteModel::Borrar_Cliente($idCliente);
