...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105);
            // Title
            $this->Cell(105,10,'REPORTE DE CUENTAS ACUMULATIVAS ACTIVAS',0,0,'C');
...
// Page footer
    ...
    $listado = $objCuentasacumulativa->Listar_Cuentasacumulativa_Activos();
...
try {
  ...
  /*  $pdf->Cell(22,5,'Stock',0,0,'C',1);*/
    ...
    if (is_array($listado) || is_object($listado))
    {
        ...
        $pdf->Text(10,$get_Y + 10,'TOTAL DE CUENTAS ACUMULATIVAS ACTIVAS : '.number_format($total));
    }
