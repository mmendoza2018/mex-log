...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105);
            // Title
            $this->Cell(105,10,'REPORTE DE LIBRO DIARIO MOVIMIENTOS INACTIVOS',0,0,'C');
            // Line break
            $this->Ln(20);
        }
    }
...
// Page footer
    ...
    $listado = $objLibrodiario->Listar_Librodiario_Inactivos();
   ...
   /* $pdf->Cell(22,5,'P. Venta',0,0,'C',1);
    ...
    if (is_array($listado) || is_object($listado))
    {
        ...
        $pdf->SetFont('Arial','B',11);
         $pdf->Text(10,$get_Y + 10,'TOTAL DE MOVIMIENTOS INACTIVOS : '.number_format($total));
    }


    $pdf->Output('I','Librodiario_Inactivos.pdf');
