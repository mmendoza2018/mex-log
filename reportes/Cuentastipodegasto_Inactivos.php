...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105);
            // Title
            $this->Cell(105,10,'REPORTE DE TIPOS DE GASTO INACTIVOS',0,0,'C');
...
// Page footer
    ...
    $listado = $objCuentastipodegasto->Listar_Cuentastipodegasto_Inactivos();
...
*/
        ...
        $pdf->Text(10,$get_Y + 10,'TOTAL DE TIPOS DE GASTO INACTIVOS : '.number_format($total, 2, '.', ','));
    }
