...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105);
            // Title
            $this->Cell(105,10,'REPORTE DE ATRIBUTOS ACTIVOS',0,0,'C');
...
// Page footer
    ...
    function __autoload($className){
           ...
           require_once("../model/Cuentasatributos_model.php");
           require_once("../controller/Cuentasatributos_controller.php");
    }

    $objCuentasatributos = new Cuentasatributos();
    $listado = $objCuentasatributos->Listar_Cuentasatributos_Activos();
...
try {
  ...
  /*  $pdf->Cell(22,5,'Stock',0,0,'C',1);*/
    ...
    if (is_array($listado) || is_object($listado))
    {
        ...
        $pdf->Text(10,$get_Y + 10,'TOTAL DE ATRIBUTOS ACTIVOS : '.number_format($total, 2, '.', ','));
    }
