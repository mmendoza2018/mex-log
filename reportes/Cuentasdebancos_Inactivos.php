...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105);
            // Title
            $this->Cell(105,10,'REPORTE DE CUENTAS DE BANCOS INACTIVAS',0,0,'C');
...
// Page footer
    ...
    function __autoload($className){
           ...
           require_once("../model/Cuentasdebancos_model.php");
           require_once("../controller/Cuentasdebancos_controller.php");
    }

    $objCuentasdebancos = new Cuentasdebancos();
    $listado = $objCuentasdebancos->Listar_Cuentasdebancos_Inactivos();
...
*/
            $pdf->setX(9);
            $pdf->Cell(30,5,$column["id_debancos"],0,0,'L',1);
        ...
        $pdf->Text(10,$get_Y + 10,'TOTAL DE CUENTAS DE BANCOS INACTIVAS : '.number_format($total));
    }
