...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105);
            // Title
            $this->Cell(105,10,'REPORTE DE CUENTAS DE BANCOS ACTIVAS',0,0,'C');
...
// Page footer
    ...
    $listado = $objCuentasdebancos->Listar_Cuentasdebancos_Activos();
...
try {
  ...
  /*  $pdf->Cell(22,5,'Stock',0,0,'C',1);*/
    ...
    if (is_array($listado) || is_object($listado))
    {
        ...
        $pdf->Text(10,$get_Y + 10,'TOTAL DE CUENTAS DE BANCOS ACTIVAS : '.number_format($total));
    }
