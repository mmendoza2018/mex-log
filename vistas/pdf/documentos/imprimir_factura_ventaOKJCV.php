...
//$users = intval($_SESSION['id_users']); //JCV MAY42023 PARA POSVAX
...
//  jcv si funciona para nueva factura $last_factura = $rw['last'];
$last_factura = $_POST['id_factura'];
...
if ($count == 1) {
    ...
    header("location: new_ventaOKJCV.php");
    exit;
}
?>
...
<?php include "encabezado_facturaOKJCV_1.php";?>
    <br>
