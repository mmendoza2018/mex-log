...
$users         = intval($_SESSION['user_id']);//admin
/*Fin datos empresa*/
...
//JCV OK ORIGINAL POR SQL: $last_factura = $rw['last'];
// JCV POR METODO POST: ASÍ SE ME HACE MÁS SEGURO POR SI ALTERAN LA FACTURA 
