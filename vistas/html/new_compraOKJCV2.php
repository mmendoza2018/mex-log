						...
						<div class="portlet">
							...
							<div id="bg-primary" class="panel-collapse collapse show">
								<div class="portlet-body">
									<?php
include "../modal/buscar_productos_comprasOKJCV.php";
    include "../modal/registro_proveedorOKJCV.php";
...
<?php require 'includes/footer_startOKJCV2.php'       /*JCV PARA EL AUTOCOMPLETE */ 
?>
...
<br>
<?php 
$rutita="SERVidor[DOCUMENTo raiz]   " ;
$rutasss = $_SERVER['DOCUMENT_ROOT'];
echo $rutita  . $rutasss;
?>
...
<script type="text/javascript" src="../../js/compraOKJCV2.js"></script> 
<!-- ============================================================== --> 
	...
	$(function() { 
		$("#nombre_proveedor").autocomplete({
			/*source: "../ajax/autocomplete/proveedorOKJCV.php",*/
                   ...
                   // OK source: "../ajax/autocomplete/proveedorOKJCV0.php",     
                    source: "http://localhost/admin/vistas/ajax/autocomplete/proveedorOKJCV.php",
...
<script>
	function showDiv(select){
		if(select.value==4){
			$("#resultados2").load("../ajax/carga_prima2OKJCV.php");
		} else{
