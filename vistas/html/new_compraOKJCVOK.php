                        ...
                        <div class="portlet">
                            <div id="bg-primary" class="panel-collapse collapse show"> <!--JCV PARA LA PRIMER PARTE DEL FORMULARIO DASTOS DEL PROVEEDOR-->
                                <div class="portlet-body">
                                                    ...
                                                    <form role="form" id="datos_factura" > 
                                                        ...
                                                        <div class="col-md-2" >
                                                                ...
                                                                <input id="id_proveedor" name="id_proveedor" type='hidden'> 	
                                                                    <label for="fiscal"># Orden C.</label>
                                                                        ...
                                                                        <div id="f_resultado" id="oc" name="oc" ></div><!-- Carga los datos ajax del incremento de la fatura -->
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                        ...
                                                        <!--<div class="row">-->
                                                            ...
                                                            <div class="col-md-1" align="center">
                                                                <button type="submit" id="guardar_factura" class="btn btn-danger btn-block btn-lg waves-effect waves-light" style="height: 40px; margin-top: 26px"> Guardar</button>
                                    ...
                                    </div>       <!--JCV DEL ROW DE DATOS DE LA FACTURA--> 
...
<script type="text/javascript" src="./js/compraOKJCVOK.js"></script>
<!-- ============================================================== -->
