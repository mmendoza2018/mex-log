...
include "../modal/agregar_fecha_depago.php"; /*JCV PARA MANDAR LLAMAR LA VENTANA DE AGREGAR FECHAS PROMESAS DE PAGO*/
...
<!-- ============================================================== -->
	...
	<script type="text/javascript" src="../../js/VentanaCentradaOKJCV.js"></script>
        <script type="text/javascript" src="../../js/editar_ventaOKJCV.js"></script>
