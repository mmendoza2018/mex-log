        ...
        <form role="form" id="datos_factura">
                            <div id="bg-primary" class="panel-collapse collapse show"> <!--JCV PARA LA PRIMER PARTE DEL FORMULARIO DASTOS DEL PROVEEDOR-->
                                <div class="portlet-body">
                                    <div class="row">     
                                        <div class="col-lg-14">
                                            <div class="card-box" style="padding-top: 3px; padding-bottom: 2px;"> <!--JCV INICIA DATOS DELPROVEEDOR Y DE LA OC-->
...
?>
                    ...
                    <div class="row">
                        <div class="col-lg-14">
                                <div class="card-box" style="padding-top: 3px; padding-bottom: 2px;"> <!--jcv de la busqueda de ARTICULOS-->
                                        <div class="widget-chart">
                                                ...
                                                <div class="row">
                                                            ...
                                                            <!--<label class="col-5 col-form-label"></label> <!-- JCV PARA DEJAR ESPACIO ENTRE BOTON GUARDAR Y TEXTBOX-->
                                                    <!--        
