...
if (isset($_GET['numero_factura'])) {
    ...
    if ($count > 0) {
        ...
        /*header("location: ./vistas/html/cxcCOT.php");*/
        exit;
    } 
} else {
    /*header("location: ./vistas/html/cxcCOT.php");*/
...
<?php require './vistas/html/includes/header_endOKJCV0abono.php';?>  
    ...
    ?>
                                <div class="breadcrumb-line" ">
                                    <ul class="breadcrumb" style="height: 15px; padding-top: 3px; ">
                                        ...
                                        <li><a href="javascript:;">Cuentas x cobrar</a></li>  
                                        <li class="active">Abonos de clientes</li> 
                                    </ul>
                                </div> 
					<div class="col-lg-14">
						<div class="portlet">
							...
							<div id="bg-primary" class="panel-collapse collapse show">
									...
									<div class="row">
										<div class="col-lg-4">
											<?php
include "./vistas/modal/agregar_abonoJCV.php";
    ?>
											<div class="col-lg-12 col-md-6">
												<div class="widget-bg-color-icon card-box">
													...
													<h5 class="text-dark"><b class="counter"><?php echo $rw['nombre_cliente']; ?></b></h5>
														<a class='btn btn-primary waves-effect waves-light btn-sm m-b-5' href="./?View=PagoCliente" title="Regresar a los Créditos"><i class="fa fa-reply"></i> Regresar
														</a> 
													...
													<form class="form-horizontal" role="form" id="datos_cotizacion">
														<div class="form-group row">
															<div class="col-xs-4">
																<div class="input-group">
																	...
																	<input type="text" class="form-control daterange pull-right" value="<?php echo "01/01" . date('/Y') . ' - ' . date('d/m/Y'); ?>" id="range" readonly>
														...
														<button class="btn btn-info waves-effect waves-light" type="button" onclick='load(1);'><i class='fa fa-search'></i></button>
															...
															<div class="col-xs-2">
																<div class="btn-group pull-center">
																	<?php if ($permisos_ver == 1) {?>
																	<button type="button"  onclick="reporte();" class="btn btn-default waves-effect waves-light" title="Imprimir reporte de abonos"><i class='fa fa-print'></i></button>
																	<?php }?>
																</div>
															</div>
														</div>
...
<!-- ============================================================== -->
<script type="text/javascript" src="./js/ver_cxcJCV.js"></script>
...
<script> 
	function reporte() {
		...
		var tipo = $("#tipo").val();
		VentanaCentrada('./vistas/pdf/documentos/rep_cxcOKJCV.php?daterange=' + daterange, 'Reporte', '', '800', '600', 'true');
	}
</script>
<script> 
	function imprimir_abono(id_abono) {
		VentanaCentrada('./vistas/pdf/documentos/rep_abonoOKJCV.php?id_abono=' + id_abono, 'Reporte', '', '800', '600', 'true');
	}
</script>
