...
/*include "./vistas/modal/buscar_productos_comprasOKJCVOK.php";                                                                         */
include "./vistas/modal/buscar_productos_ventasOKJCVOK.php";
										...
										<div class="col-lg-4">
											<div class="card-box">
												<div class="widget-chart">
													...
													<form role="form" id="datos_facturaJCV">
...
<script type="text/javascript" src="./js/cotizacionOKJCVOK.js"></script>
<!-- ============================================================== -->
...
<script>
    ...
    $("#id_clientejcv").change(function(){ 
        ...
        /*
            var Id_clientejcv = $('#id_clientejcv').val();
            Id_clientejcv = parseInt(Id_clientejcv);
            var formData = new FormData();
    
$('#id_cliente').val(Id_clientejcv);
            formData.append("id_clientejcv", Id_clientejcv);

            $.ajax
            (
                {
                    url : "./vistas/ajax/traer_datos_cliente.php",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
...
function printFactura(id_factura) {
	...
	if (id_factura) {
		$.ajax({
			url: './vistas/pdf/documentos/imprimir_cotizacionOKJCVOK.php',
			type: 'post',
			data: {
