...
/* Connect To Database*/
/*JCV AL INCLIUR LA COTIZACIONES CAMBIA LA PATH. YA QUE POR DEFAUL LAS VISTAS (VIEW) ESTAN
EN LA CARPETA VIEW, POR LO TANTO, LA DIRRECCION ES A PARTIR DE LA CARPETA VIEW DE AHÍ QUE CAMBIAR
A vistas/dbOKJCV.php Y NO COMO ES DE FORMA ORIGINAL A ../dbOKJCV.php */
...
/*JCV AL INCLIUR LA COTIZACIONES CAMBIA LA PATH. YA QUE POR DEFAUL LAS VISTAS (VIEW) ESTAN
EN LA CARPETA VIEW, POR LO TANTO, LA DIRRECCION ES A PARTIR DE LA CARPETA VIEW DE AHÍ QUE CAMBIAR
A vistas/permisosOKJCV.php Y NO COMO ES DE FORMA ORIGINAL A ../permisosOKJCV.php */
...
<!-- Begin page -->
<!-- JCV ORIG PERO CON forced enlarged OCUPA TOSA LA PANTALLA <div id="wrapper"> -->
<div id="wrapper" class="forced enlarged">

    <!--JCV PARA QUITAR DE LA VISTA EL MENU-->
				...
				<div class="col-lg-12">
					<div class="portlet">
						<div class="portlet-heading bg-primary">
							<h3 class="portlet-title" style="margin-left: 1%; padding: 0.5%">
						...
						<div id="bg-primary" class="panel-collapse collapse show">
							...
							<?php
/*include "../modal/eliminar_facturaOKJCV.php";*/
/*JCV AL INCLIUR LA COTIZACIONES CAMBIA LA PATH. YA QUE POR DEFAUL LAS VISTAS (VIEW) ESTAN
EN LA CARPETA VIEW, POR LO TANTO, LA DIRRECCION ES A PARTIR DE LA CARPETA VIEW DE AHÍ QUE CAMBIAR */
									...
									<div class="form-group row">
										<div class="col-md-5">
											<div class="input-group">
												<input type="text" class="form-control" id="q" placeholder="Nombre del cliente o # cotización" onkeyup='load(1);'>
...
?>
	...
	<!--<script type="text/javascript" src="../../js/bitacora_cotizacionOKJCV.js"></script>-->
        <script type="text/javascript" src="./js/bitacora_cotizacionOKJCV.js"></script>
