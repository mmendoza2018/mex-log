...
<div class="topbar">
	...
	<div class="topbar-left">
		<div class="text-center">
			<a href="#" class="logo"><i class="mdi mdi-radar"></i> <span>Advance Medical</span></a>
		</div>
	</div>
	...
	<nav class="navbar-custom">
		...
		<ul class="list-inline float-right mb-0">
			...
			<li class="list-inline-item dropdown notification-list">
				...
				<img src="../../assets/images/users/defecto.png" alt="user" class="rounded-circle">
			</a>
			<div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
				...
				<!-- item-->
				<a href="../../loginOKJCV.php?logout" class="dropdown-item notify-item">
...
<div class="left side-menu"> 
	<div class="sidebar-inner slimscrollleft">
		...
		<div id="sidebar-menu">
			<ul> 
				<li>
					<a href="../html/principalOKJCV.php" class="waves-effect waves-primary"><img src="../../img/025-arquitectura-y-ciudad.png" alt="inicio" width="30"> </i><span> Inicio </span></a>
					</li>
					<li>
							...
							<li class="has_sub">
								...
								<!--<li>
									...
									<li class="has_sub">
										...
										<ul class="list-unstyled">
											<li><a href="../html/new_ventaOKJCV.php"><img src="../../img/008-shopping-online-1.png" alt="nueva venta" height="20" width="20">Nueva Venta</a></li>
											<li><a href="../html/bitacora_ventasOKJCV.php"><img src="../../img/013-bill.png" alt="listado" height="20" width="20">Historial de Ventas</a></li>
											<!--<li><a href="../html/caja.php">Caja</a></li>-->
										</ul>
									</li>
									<li class="has_sub">
										<a href="javascript:void(0);" class="waves-effect waves-primary"><img src="../../img/012-files-and-foldersOKJCV.png" alt="presupuestos" width="30"></i><span> Cotización
										</span> <span class="menu-arrow"></span></a>
										<ul class="list-unstyled">
											<li><a href="../html/new_cotizacionOKJCV.php"><img src="../../img/015-diplomaOKJCV.png" alt="nuevo" height="20" width="20">Nueva Cotización</a></li>
											<li><a href="../html/bitacora_cotizacionOKJCV.php"><img src="../../img/016-car-2OKJCV.png" alt="listado" height="20" width="20">Historial de Cotizacíon</a></li>
										</ul>
									</li>
										<li class="has_sub">
										<a href="javascript:void(0);" class="waves-effect waves-primary"><img src="../../img/012-business-and-finance.png" alt="recibos" width="30"></i><span> Cobros y Pagos </span>
												<span class="menu-arrow"></span></a>
												<ul class="list-unstyled">
													<li><a href="../html/cxcOKJCV.php"><img src="../../img/010-ticketOKJCV.png" alt="recibos" height="20" width="20">Pago Cliente</a></li>
