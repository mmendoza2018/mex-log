...
/* Connect To Database*/
/* JCV ORIGrequire_once "../dbOKJCV.php"; //Contiene las variables de configuracion para conectar a la base de datos*/
require_once "./vistas/dbOKJCV.php"; //Contiene las variables de configuracion para conectar a la base de datos

/* JCV ORIGrequire_once "../php_conexionOKJCV.php"; //Contiene funcion que conecta a la base de datos */
require_once "./vistas/php_conexionOKJCV.php"; //Contiene funcion que conecta a la base de datos
//Inicia Control de Permisos

/* JCV ORIG include "../permisosOKJCV.php";*/
...
<?php if ($permisos_ver == 1) {
    ...
    include "./vistas/modal/ver_datosOKJCV.php";
    ?>
				<div class="col-lg-12">
					<div class="portlet">
...
?>
	...
	<!-- ============================================================== -->
	<!-- jcv ORIGINAL <script type="text/javascript" src="../../js/VentanaCentradaOKJCV.js"></script>-->
        <script type="text/javascript" src="./js/VentanaCentradaOKJCV.js"></script>
        
        
	<!-- jcv ORIGINAL<script type="text/javascript" src="../../js/cxcOKJCV.js"></script> -->
	...
	<script>
		function obtener_datos(numero_factura) {
			/* JCV ORIG $(".outer_datos").load("../modal/datosOKJCV.php?numero_factura=" + numero_factura);*/
                        $(".outer_datos").load("./vistas/modal/datosOKJCV.php?numero_factura=" + numero_factura);
		}
	</script>

	<?php /* orig  require 'includes/footer_endOKJCV.php'*/
?>
