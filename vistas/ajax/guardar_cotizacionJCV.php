...
// fin de numero de fatura
    ...
    $('#modal_cot').modal('show');
     ...
     /*  echo "<script>
       swal('COMPRA GUARDADA AL CREDITO CON ATICIPO DE: $simbolo_moneda ', 'Factura: $factura', 'success')
  </script>";
       */
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class='fa fa-edit'></i> Imprimir Cotización</h4>
            </div>
            <div class="modal-body" align="center">
                <strong><h3>Número de cotización:</h3></strong>
