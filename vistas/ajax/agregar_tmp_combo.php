...
if (!empty($id) and !empty($cantidad)) {
    ...
    $costo_producto_tmp = get_row('productos', 'costo_producto', 'id_producto', $id_producto);
    ...
    $comprobar = mysqli_query($conexion, "select * from tmp_combo, productos where productos.id_producto = tmp_combo.id_producto and  tmp_combo.id_producto='" . $id_producto . "' and session_id='" . $session_id . "'");
    ...
    if ($row = mysqli_fetch_array($comprobar)) {
        ...
        //$sql          = "UPDATE tmp_combo SET cantidad_tmp='" . $cant . "' WHERE id_producto='" . $id_producto . "' and session_id='" . $session_id . "'";
        $sql          = "UPDATE tmp_combo SET cantidad_tmp='" . $cant . "', costo_producto_tmp='" . $costo_producto_tmp . "', precio_tmp='" . $precio_venta . "' WHERE id_producto='" . $id . "' and session_id='" . $session_id . "'";
        ...
        $insert_tmp = mysqli_query($conexion, "INSERT INTO tmp_combo (id_producto,cantidad_tmp,costo_producto_tmp,precio_tmp,desc_tmp,session_id) VALUES ('$id_producto','$cantidad','$costo_producto_tmp','$precio_venta','0','$session_id')");
