...
if (!empty($id) and !empty($cantidad)) {
    ...
    if ($row = mysqli_fetch_array($comprobar)) {
        ...
        if ($cantidad > $stock and $inv == 0) {
            ...
            $insert_tmp = mysqli_query($conexion, "INSERT INTO detalle_fact_ventas (id_factura,numero_factura, id_producto,cantidad,precio_venta,importe_venta,origen) VALUES ('$id_factura','$numero_factura','$id_producto','$cantidad','$precio_venta','$importe', '$numero_factura')");
            $update     = eliminar_stock($id_producto, $cantidad); // Descuenta del inventario
        }
        // fin codicion cantaidad
    }
