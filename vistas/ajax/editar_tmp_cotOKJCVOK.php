...
<div class="table-responsive"> 
    <table class="table table-sm table-striped" ><!--JCV table-striped: TABLA CON RAYAS DE CEBRA, table-hover:EFECTO DE HOVER AL ESTAR EN CADA FILA -->
...
while ($row = mysqli_fetch_array($sql)) {
    ...
    <tr>
        ...
        <div class="col-xs-4">
            ...
            <input class="form-control txt_costo" value="<?php echo $precio_venta_r; ?>" id="<?php echo $id_detalle; ?>" type="text">
        </div>
        </td>
        -->
