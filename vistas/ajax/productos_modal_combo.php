        ...
        ?> 
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-sm">
                <tr  class="info">
                    <!-- JCV PARA LA FOTO DEL PRODUCTO <th></th>-->
                    <th>COD.</th>
                    <th class='text-center'>PRODUCTOS modal combo</th> 
...
while ($row = mysqli_fetch_array($query)) {
     ...
     <?php /* JCV PARA LA FOTO DEL PRODUCTO
if ($image_path == null) {
                echo '<img src="./img/productos/defaultOKJCV.jpg" class="" width="60">';
            } else {
        ...
        */    ?>
                        ...
                        <td class='text-center'>
                        <a class='btn btn-success' href="#" title="Agregar a combo" onclick="agregar('<?php echo $id_producto ?>')"><i class="fa fa-plus"></i>
                        </a>
                        </td>
                    </tr>
                    <?php 
