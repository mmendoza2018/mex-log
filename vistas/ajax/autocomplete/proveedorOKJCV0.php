<?php
if (isset($_GET['term'])) {     
    //http://localhost/admin/vistas/ajax/autocomplete/proveedorOKJCV0.php
    include "http://localhost/admin/vistas/dbOKJCV.php";
    include "http://localhost/admin/vistas/php_conexionOKJCV.php";
    print("nada es nada");
    //include "../../dbOKJCV.php";
