...
*/
            ?>
                  ...
                  <!--  </td>-->
                    ...
                    <td><span class='pull-right'><?php echo $simbolo_moneda . '' . number_format($costo_producto, 2); ?></span></td>
                    <td><span class='pull-right'><?php echo $simbolo_moneda . '' . number_format($precio_producto, 2); ?></span></td>
                    <td><span class='pull-right'><?php echo $simbolo_moneda . '' . number_format($precio_mayoreo, 2); ?></span></td>
                    <td><span class='pull-right'><?php echo $simbolo_moneda . '' . number_format($precio_especial, 2); ?></span></td>
