...
//Cmprobamos si agregamos un producto a la tabla tmp_compra
    ...
    if ($row = mysqli_fetch_array($comprobar)) {
        ...
        $sql  = "UPDATE tmp_compra SET cantidad_tmp='" . $cant . "', costo_tmp='" . $precio_venta . "', statusalmacen='" . $status_almacen . "', fechaingreso='" . $date . "' WHERE id_producto='" . $id . "' and session_id='" . $session_id . "'";
        ...
        $insert_tmp = mysqli_query($conexion, "INSERT INTO tmp_compra (id_producto,cantidad_tmp,costo_tmp,session_id,statusalmacen) VALUES ('$id','$cantidad','$precio_venta','$session_id','$status_almacen')");
...
<div class="table-responsive">
    <table class="table table-sm">
        <thead class="thead-default">
            <tr>
                <th class='text-center'>COD. ya agregada eliminada</th>
                <th class='text-center'>CANT.</th>
                <th>DESCRIP.</th>
                <th class='text-center'>COSTO</th>
                <th class='text-right'>TOTAL</th>
                <th></th>
                <th class='text-right'>OBSERV. A.</th>
