                          ...
                          <div class="btn-group dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" style=" font-size: 1.2em">
                               <?php if ($permisos_editar == 1) {?>
                                <li><a class="dropdown-item" href="./?View=EditarEquiposaComprar&id_factura=<?php echo $id_factura; ?>"><i class='fa fa-edit'></i> Editar</a></li>
                                
                               <li><a class="dropdown-item" href="#" onclick="print_ticket('<?php echo $id_factura; ?>')"><i class='fa fa-print'></i> Imprimir Ticket</a></li>
                               <li><a class="dropdown-item" href="#" onclick="imprimir_factura('<?php echo $id_factura; ?>');"><i class='fa fa-print'></i> Imprimir Factura</a></li>
                               <?php }
