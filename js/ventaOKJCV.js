$(document).ready(function() {
    ...
    $("#resultados2").load("../ajax/carga_cajaOKJCV.php");
...
function agregar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_modalventasOKJCV.php",
...
$("#barcode_form").submit(function(event) {
    ...
    $.ajax({
        ...
        success: function(datos) {
            ...
            $("#id").focus();
            $("#barcode").val("");
            $("#f_resultado").load("../ajax/incrementa_facturaOKJCV.php"); //Actualizamos el numero de Factura
        }
    });
...
$("#datos_factura").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/guardar_ventaOKJCV.php",
        data: parametros,
        beforeSend: function(objeto) {
        ...
        success: function(datos) {
            ...
            $("#resultados").load("../ajax/agregar_tmpOKJCV.php"); // carga los datos nuevamente
            $("#f_resultado").load("../ajax/incrementa_facturaOKJCV.php"); // carga la caja de incrementar la factura
            $("#resultados2").load("../ajax/carga_cajaOKJCV.php"); // carga la caja total del dia
            $("#barcode").focus();
            load(1);
...
$('#dataDelete').on('show.bs.modal', function(event) {
        ...
        $("#eliminarDatos").submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "../ajax/anular_facturaOKJCV.php",
                data: parametros,
                beforeSend: function(objeto) {
