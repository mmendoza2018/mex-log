$(document).ready(function() { 
    ...
    $("#f_resultado").load("./vistas/ajax/incrementa_fact_compraOKJCV.php"); 
    $("#datos_factura").load();
    load(1);
});
...
function agregar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "./vistas/ajax/agregar_tmp_modalcomprasOKJCV.php",
...
$("#datos_factura").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "./vistas/ajax/guardar_compraOKJCV.php",
        data: parametros,
        beforeSend: function(objeto) {
        ...
        success: function(datos) {
            ...
            $("#resultados").load("./vistas/ajax/agregar_tmp_compraOKJCV.php"); // carga los datos nuevamente
            $("#f_resultado").load("./vistas/ajax/incrementa_fact_compraOKJCV.php");
            $("#barcode").focus();
            load(1);
