		...
		function load(page) { 
		    ...
		    $("#loader").fadeIn('slow');
		    $.ajax({ 
		        /*url: '../ajax/buscar_ventasOKJCV.php?action=ajax&page=' + page + '&q=' + q,*/
                        url: './vistas/ajax/buscar_ventasOKJCV.php?action=ajax&page=' + page + '&q=' + q,
		...
		function imprimir_factura(id_factura) {
		    //VentanaCentrada('../pdf/documentos/ver_facturaOKJCV.php?id_factura=' + id_factura, 'Factura', '', '724', '568', 'true');
                    //VentanaCentrada('./vistas/pdf/documentos/ver_factura_ventasOKJCVOK.php?id_factura=' + id_factura, 'Factura', '', '724', '568', 'true');
                    VentanaCentrada('./vistas/pdf/documentos/pdf_ventas.php?id_factura=' + id_factura, 'Factura', '', '724', '568', 'true');
		}
