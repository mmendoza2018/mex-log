...
function agregar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/editar_tmp_modalventasOKJCV.php",
...
$("#datos_factura").submit(function(event) { //El formulario envia los datos aqui
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/editar_fact_ventaOKJCV.php",
        data: parametros,
        beforeSend: function(objeto) {
...
function imprimir_factura(id_factura) {
    VentanaCentrada('../pdf/documentos/ver_factura.phpOKJCV?id_factura=' + id_factura, 'Factura', '', '724', '568', 'true');
}