		$(document).ready(function() {
		    $("#cod_resultado").load("./vistas/ajax/incrementa_cod_prodOKJCV.php");
		    load(1);
		});
		...
		function load(page) {
		    ...
		    $("#loader").fadeIn('slow');
		    $.ajax({
		        url: './vistas/ajax/buscar_productosOKJCV.php?action=ajax&page=' + page + '&q=' + q + '&categoria=' + categoria,
		...
		$("#editar_producto").submit(function(event) {
		    ...
		    $.ajax({
		        type: "POST",
		        url: "./vistas/ajax/editar_productoOKJCV.php",
		        data: parametros,
		        beforeSend: function(objeto) {
		...
		$("#eliminarDatos").submit(function(event) {
		    ...
		    $.ajax({
		        type: "POST",
		        url: "./vistas/ajax/eliminar_productoOKJCV.php",
		        data: parametros,
		        beforeSend: function(objeto) {
		        ...
		        success: function(datos) {
		            ...
		            //desaparecer la alerta
		            window.setTimeout(function() {
		                $(".alert").fadeTo(20, 0).slideUp(20, function() {
		                    $(this).remove();
		                });
		            }, 200);
		        }
