$(document).ready(function() {
    $("#resultados").load("../ajax/agregar_tmp_compraOKJCV.php");
    $("#resultados2").load("../ajax/carga_resibido2OKJCV.php");
    $("#f_resultado").load("../ajax/incrementa_fact_compraOKJCV.php");
    $("#datos_factura").load();
    load(1);
});
...
function load(page) {
    ...
    $.ajax({
        ...
        url: '../ajax/productos_modal_compras2OKJCV.php?action=ajax&page=' + page + '&q=' + q,
...
function agregar(id) { /*JCV AGREGAR PRODUCTO EN LA COMPRA*/
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_modalcomprasOKJCV.php", 
        ...
        success: function(datos) {
            ...
            $.Notification.notify('success', 'bottom center', 'EXITO!', 'PRODUCTO AGREGADO A LA COMPRA CORRECTAMENTE')
        }
    });
}
...
$("#barcode_form").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_compraOKJCV.php",
        data: parametros,
        beforeSend: function(objeto) {
            $("#resultados").html('<img src="../../img/ajax-loader.gif"> Cargando...');
        },
...
$("#datos_factura").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/guardar_compraOKJCV2.php",
        data: parametros,
        beforeSend: function(objeto) {
        ...
        success: function(datos) {
            ...
            $("#resultados").load("../ajax/agregar_tmp_compraOKJCV.php"); // carga los datos nuevamente
            $("#f_resultado").load("../ajax/incrementa_fact_compraOKJCV.php");
            $("#barcode").focus();
            load(1);
...
$("#guardar_proveedor").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/nuevo_proveedorOKJCV.php",
        data: parametros,
        beforeSend: function(objeto) {
...
function imprimir_factura(id_factura) {
    VentanaCentrada('../pdf/documentos/ver_compraxOKJCV.php?id_factura=' + id_factura, 'Factura', '', '724', '468', 'true');
}