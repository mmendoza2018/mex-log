$(document).ready(function() {   
    $("#resultados").load("../ajax/agregar_tmp_cotOKJCV.php");
    $("#f_resultado").load("../ajax/incrementa_fact_cotOKJCV.php");
    $("#datos_factura").load();
    $("#barcode").focus();
    load(1);
});
...
function agregar(id) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_modalcotOKJCV.php", 
...
$("#barcode_form").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/agregar_tmp_cotOKJCV.php",
        data: parametros,
        beforeSend: function(objeto) {
            $("#resultados").html('<img src="../../img/ajax-loaderOKJCV.gif"> Cargando...');
        },
        success: function(datos) {
            ...
            $("#id").focus();
            $("#barcode").val(""); 
            $("#f_resultado").load("../ajax/incrementa_fact_cotOKJCV.php"); //Actualizamos el numero de Factura
        }
    });
...
$("#datos_factura").submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "../ajax/guardar_cotizacionOKJCV.php",
        data: parametros,
        beforeSend: function(objeto) {
        ...
        success: function(datos) {
            ...
            $("#resultados").load("../ajax/agregar_tmp_cotOKJCV.php"); // carga los datos nuevamente
            $("#f_resultado").load("../ajax/incrementa_fact_cotOKJCV.php"); // carga la caja de incrementar la factura
            $("#barcode").focus();
            load(1);
