...
<head>
	...
	<meta name="autor" content="Vacx Apps">
	<meta name="description" content="AdminVacx es un sistema de ventas que le permite llevar el control de todo lo relacionado a su negocio.">
	<title>Vacx Apps - Un sistema a tu medida</title>
	...
	<!-- /theme JS files -->
        ...
        <!--
         <link rel="stylesheet" type="text/css" href="jcv2/stylejcv2.css" /> 
        <script type="text/javascript" src="jcv2/example-one.js"></script>
        --> 
			...
			<p class="navbar-text"><span class="label bg-success">En Linea</span></p>
                        ...
                        <div class="col-md-6" align="left">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="rutaraiz" name="rutaraiz" value=<?php print(RUTA_RAIZ); ?> >   
